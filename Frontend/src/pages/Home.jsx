            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text_para">
                  A Patient-first philosophy drives our decision-making across
                  the organisatton.
                </p>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                <h2 className="text-[26px] leading-9 text-headingColor text-center font-[700]">
                  Find a Doctor
                </h2>
        ...
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              <div className="w-[150px] lg:w-[255px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                ...
                <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]">
                  ...
                  <h4 className="text-[18px] leading-3 lg:text-[16px] lg:leading-[22px] font-[700] text-headingColor">
                    Wayne Collins
                  </h4>
                </div>
              </div>
